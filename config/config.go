...
func initConfig() (*Config, error) {
	...
	//DB
	flagset.StringVar(&config.Storage.Driver, "db-driver", defaultDBDriver, "Data service driver.")
	flagset.StringVar(&config.Storage.DSN, "db-dsn", defaultDSN, "Data service data source name.")
